      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-background-secondary border border-border rounded-xl p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {error && (
              <div id="login-error" className="p-3 rounded-lg bg-accent-red/10 border border-accent-red/20 dark:border-zinc-700 text-accent-red text-sm flex items-center gap-2" role="alert">
