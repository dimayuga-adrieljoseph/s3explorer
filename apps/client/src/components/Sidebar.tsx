    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex-shrink-0 border-t border-border px-3 py-2 pb-safe space-y-0">
                    {/* Connections button */}
                    {onOpenConnections && (
                        <button
                            onClick={onOpenConnections}
                            className="sidebar-item w-full justify-start !py-1.5 !px-2 !gap-2"
                        ...
                        >
                            ...
                            <span className="flex-1 truncate text-xs text-left">
                    ...
                    <div className="flex items-center gap-0.5">
                        ...
                        {onLogout && (
                            <button
                                onClick={onLogout}
                                className="sidebar-item flex-1 justify-start hover:text-accent-red !py-1.5 !px-2 !gap-2"
                                aria-label="Logout"
                            >
                        ...
                        <a
                            ...
                            className="sidebar-item flex-1 justify-start !py-1.5 !px-2 !gap-2"
                            aria-label="Visit GitHub (opens in new tab)"
                        >
                            <svg className="w-3.5 h-3.5 flex-shrink-0" viewBox="0 0 98 96" fill="currentColor" aria-hidden="true">
